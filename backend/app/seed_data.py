...
AGENTS = [
    ...
    {"agent_key": "product_agent", "label": "Produtos", "model": "claude-sonnet-4-5", "fallback_model": "claude-haiku-4-5", "persona": "Recomende produtos relevantes usando somente resultados do catálogo.", "allowed_tools": ["vector_search_products"], "max_turn_tokens": 1400, "active": True},
    {"agent_key": "support_agent", "label": "Suporte", "model": "claude-sonnet-4-5", "fallback_model": "claude-haiku-4-5", "persona": "Resolva dúvidas técnicas com evidência da base de conhecimento e transfira quando necessário.", "allowed_tools": ["hybrid_search_kb", "handoff"], "max_turn_tokens": 1400, "active": True},
