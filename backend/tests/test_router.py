...
RULES = [
    ...
    {"intent": "defeito", "keywords": ["defeito"], "target_agent": "support_agent", "priority": 80},
...
def test_cheap_router_sends_ambiguous_tie_to_orchestrator():
    assert cheap_route("meu fone tem defeito e quero um parecido", RULES) is None
